...
- 🛡️ Cybersecurity projects & threat analysis
##### 🌱 Learning Journey  
- 🐳 Docker 
- 🕵️ T-Pot
##### 👯 Collaboration Goals  
- 🚀 AI/Cybersecurity open-source projects  
- 🎮 Indie game development (hit me up if you need a Unity/Python buddy!)  
##### 💬 Ask Me About  
- ⭐ Star Wars lore (Who shot first? I have *opinions*)  
- 🖥️ Python scripting magic  
...
**Frozenn-X/Frozenn-X** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
